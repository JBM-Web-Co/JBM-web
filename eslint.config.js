...
export default [
    ...
    },
    {
        ...
        rules: {
            ...
            // Naming conventions mirror the /code-style skill:
            //   Local variables    -> snake_case (UPPER_CASE for local constants)
            //   Exported variables -> camelCase / PascalCase (components, schemas) / UPPER_CASE
            //   Local functions    -> snake_case or PascalCase (local components)
            //   Exported functions -> camelCase (incl. hooks) or PascalCase (components)
            //   Parameters         -> snake_case (leading underscore for intentionally unused)
